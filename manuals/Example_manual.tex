...
\begin{itemize}
  ...
  \item Elegir la longitud de arco inicial en la escala del problema.
...
El síntoma se ve en el esfuerzo medio, $(\sigma_{xx} + \sigma_{yy} + \sigma_{zz})/3$. En el colapso exacto vale $\sigma_{rr} + \sigma_y/\sqrt3$, entre $-54$ MPa en la cara interior y 139 MPa en la exterior. Con 1 mm de desplazamiento exterior, el Quad4 tiene puntos de Gauss entre $-224$ y 171 MPa: una presión espuria, que el criterio de von Mises no limita porque sólo acota la parte desviadora del esfuerzo. El Tri6 y los dos Quad8 quedan dentro del intervalo exacto, salvo el error de discretización.
...
Compilado el 23 de septiembre de 2026, 11:49\\[0.5em]
