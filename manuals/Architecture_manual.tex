...
\textbf{Limitaciones declaradas en esta fase}:

\begin{itemize}
  \item Solo lineal: \texttt{K, M} constantes. No-linealidad (Newton dentro de Newmark) diferida a la fase 4.
  ...
  \item Esquemas con amortiguamiento numérico controlado (HHT-\ensuremath{\alpha}, generalized-\ensuremath{\alpha}) diferidos a subclase futura.
\end{itemize}
