...
Solver & \texttt{solidum/math/solver\_<snake>.py} & \texttt{@SolverRegistry.register} & No \\
\hline
\end{tabularx}
\end{center}
...
Compilado el 25 de agosto de 2026, 16:58\\[0.5em]
