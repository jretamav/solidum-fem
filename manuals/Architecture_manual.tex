...
\textbf{Consecuencia.} El consumidor externo no recalcula esfuerzos a partir de \texttt{U}; la lógica de MEF reside íntegramente en Solidum FEM. La incorporación de un elemento nuevo obliga a implementar \texttt{internal\_forces} con las claves de su familia: el contrato es explícito.
...
Compilado el 19 de mayo de 2026, 18:46\\[0.5em]
