...
Fenix FEM expone el subsistema modal/dinámico/espectral \textbf{completo} (ADR 0009 cerrado en su totalidad 2026-05-18). Cubre los siete regímenes canónicos de la mecánica computacional clásica:
...
\begin{itemize}
  \item \textbf{Sólidos isoparamétricos} (Tri3, Quad4, Tri6, Quad8, Quad9): \textbf{HRZ canónico} (Hinton-Rock-Zienkiewicz 1976) centralizado en \texttt{fenix.math.mass\_lumping.lump\_hrz}. Preserva masa total y proporcionalidad diagonal; evita masas negativas en elementos de orden superior.
...
Compilado el 18 de mayo de 2026, 18:40\\[0.5em]
Commit Git: \texttt{fdd15a5} (con cambios sin confirmar)\\[1em]
