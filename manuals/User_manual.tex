...
\textbf{Densidad olvidada}. Si un material declarado no incluye \texttt{density} (o lo deja en cero), su contribución al peso propio será nula y Fenix emite un \texttt{WARNING} identificando el material concreto. Esto detecta olvidos sin romper el análisis.
