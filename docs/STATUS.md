...
| Indicador | Valor |
|---|---|
| **Tests** | 970 pasan / 8 skipped / 0 fallos (+11 vs 959 baseline post-A.ter sub-fases 1/2/3/5). **Sub-etapa A.ter cerrada por completo 2026-05-27** (sub-fase 4 NAFEMS LE10 + Lamé thick cylinder 3D entregada esta sesión): 5 tests NAFEMS LE10 (Hex20+Hex27) y 6 tests Lamé thick cylinder 3D (Hex20+Hex27) verdes; 2 tests Tet10 sobre cilindro skipped con motivo arquitectural (descomposición hex→5tets no converge sobre superficie curva — deuda técnica #8). |
...
| **Etapas cerradas** | 7 completas + **sub-etapa A.bis cerrada 2026-05-21** + **sub-etapa A.ter cerrada por completo 2026-05-27** (sólidos 3D cuadráticos: Hex20, Hex27, Tet10 + validación externa NAFEMS LE10 + Lamé thick cylinder 3D para Hex20/Hex27) |
...
**Elección de Etapa 8** tras cerrar la Etapa 7 (sólidos 3D lineales, ADR 0012, 2026-05-19), la sub-etapa **A.bis** (materiales 3D no lineales, 2026-05-21) y la sub-etapa **A.ter** completa incluyendo la validación NAFEMS 3D (2026-05-27). El catálogo 3D queda con paridad funcional completa con el 2D — 5 elementos × 4 materiales (3 no lineales + Elastic3D) todos cubiertos con ✓ y los cuadráticos validados externamente contra benchmarks publicados. Opciones para Etapa 8:
