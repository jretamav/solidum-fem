...
- **2026-09-22** · Auditoría global: misma corrección del ápice que `DruckerPrager2D`: con η_g = 0 (ψ = 0) la rama del ápice lanza `ValueError` y el constructor avisa; antes se clampaba `A_apex` a 1e-30.
