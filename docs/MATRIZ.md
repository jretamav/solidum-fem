...
Selección de tests "canónicos" que cubren combinaciones clave. La intención no es enumerar los 401 tests sino apuntar al fichero de referencia para cada celda no trivial.
