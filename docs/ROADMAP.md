...
- **I. Solver iterativo (CG precondicionado).** Evaluada **con medición** el 2026-09-23, tras el [ADR 0017](adr/0017-backend-algebraico-pardiso.md); **diferida hasta que exista un modelo que no quepa en RAM**. Se registran las cifras para no volver a medir.
