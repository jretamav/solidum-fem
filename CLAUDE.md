# Fenix FEM — instrucciones para la IA
...
- **Componentes nuevos**: usar la skill `/fenix-new <kind> <Name>` para scaffolding (kind ∈ material/element/solver). Ver `.claude/skills/fenix-new/SKILL.md`.
