---
name: solidum-new
description: Genera scaffolding para nuevos materiales, elementos o solvers de Solidum FEM (archivo + decorador de registro + test esqueleto). Úsalo cuando el usuario pida añadir/crear un material, elemento o solver derivado de su investigación.
---
...
### element — `solidum/elements/<snake>.py`
...
from solidum.elements.{{snake}} import {{Name}}
...
from solidum.math.solver_{{snake}} import {{Name}}
