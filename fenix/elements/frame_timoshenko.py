# fenix_fem/fenix/elements/frame_timoshenko.py
"""Elemento de pórtico/viga 2D Timoshenko.

Implementación **independiente** del resto de elementos. No hereda de
ninguna otra clase ni comparte utilidades con otros módulos: la geometría
y la matriz de transformación se construyen dentro de la propia clase.
Ver docs/specs/Frame2DTimoshenko.md.
"""
import math
